...
public class RealAndroidCaseTest {
	...
	private void InterpretChecker(String arg0,String arg1,String arg2,String summaryFolder, String gtfolder,String wfolder, String appfolder)
	{
	...
	public void test() {	
		...
		InterpretChecker(rtjar,appfolder+"br.com.palavrasdesabedoria.instrumented.apk",appfolder+"/br.com.palavrasdesabedoria.txt",
			appfolder+"/MethodSummary/",gt,appfolder+"/Output/", appfolder);

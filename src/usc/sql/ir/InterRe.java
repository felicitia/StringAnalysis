...
public class InterRe {
	...
	public InterRe(List<NodeInterface> nodes, Map<String, Boolean> regionDef,
			List<String> lineDef, String folderName,
			Map<NodeInterface, List<String>> targetVarNodeAndName,
			Map<String, Set<NodeInterface>> paraMap,
			Map<String, Set<String>> fieldMap, int targetCount, String methodName,
			JavaApp App, Map<String, List<Integer>> targetSignature) {
		...
		stringvirtual
				.add("<java.lang.StringBuilder: java.lang.StringBuilder append");
		stringvirtual
				.add("<java.lang.StringBuffer: java.lang.StringBuffer append");
		stringvirtual.add("<java.lang.String: java.lang.String trim()>");
		stringvirtual.add("<java.lang.String: java.lang.String intern()>");
		stringvirtual
				.add("<java.lang.String: java.lang.String[] split(java.lang.String)>");
		stringvirtual
				.add("<java.lang.String: java.lang.String[] split(java.lang.String,int)>");
		stringvirtual
		...
		stringvirtual
				.add("<java.lang.StringBuilder: java.lang.StringBuilder replace(int,int,java.lang.String)>");
		stringvirtual
				.add("<java.lang.StringBuilder: java.lang.StringBuilder delete(int,int)>");
		stringvirtual
				.add("<java.lang.StringBuilder: java.lang.StringBuilder deleteCharAt(int)>");
		stringvirtual
				.add("<java.lang.StringBuffer: java.lang.StringBuffer delete(int,int)>");
		stringvirtual
				.add("<java.lang.StringBuilder: java.lang.StringBuilder insert(int,java.lang.String)>");
		stringvirtual
				.add("<java.lang.StringBuffer: java.lang.StringBuffer insert(int,java.lang.String)>");
		stringvirtual
				.add("<java.lang.StringBuffer: java.lang.StringBuffer insert(int,char)>");
		stringvirtual
				.add("<java.lang.StringBuffer: java.lang.StringBuffer replace(int,int,java.lang.String)>");
		// non java.lang method but return string
		stringvirtual
				.add("<java.net.URLEncoder: java.lang.String encode(java.lang.String,java.lang.String)>");
	...
	private void interpret(NodeInterface n) {
		...
		if (actualNode != null) {
			...
			if (targetSignature != null && actualNode.containsInvokeExpr()) {
				String signature = actualNode.getInvokeExpr().getMethod()
						.getSignature();
				if (targetSignature.keySet().contains(signature)) {
					...
					for (ValueBox vb : actualNode.getUseBoxes()) {
						if (vb.getValue().getType().toString()
								.equals("java.lang.String")
								&& !vb.getValue().toString().contains("<")) {

							paraNum++;
							if (targetSignature.get(signature)
									.contains(paraNum)) {
								...
								for (Tag t : actualNode.getTags()) {
									if (t instanceof BytecodeOffsetTag){
										bytecodeOffset = ((BytecodeOffsetTag) t)
												.getBytecodeOffset();
									}
									
								}
								// label: the target signature is found in
								// method name at line source line + bytecode
								// offset
								nameAndLabel.add(methodName
										+ "@"
										+ actualNode
												.getJavaSourceStartLineNumber()
										+ "@" + bytecodeOffset + "@" + paraNum
										+ "@" + actualNode.toString() + "@" + nodeId);
...
//					System.out.println(v.getField().getSignature());
...
//					System.out.println();
					...
					// if value contains
					// ", add it to fieldMap, e.g. $r10, $r6, "3882438"
					if (value.contains("\"")) {
...
//						System.out.println("signature = " + signature);
						if (fieldMap.keySet().contains(signature))
							fieldMap.get(signature).add(value);
						else {
							Set<String> s = new HashSet<>();
							s.add(value);
							fieldMap.put(signature, s);
						}
					}
			...
			if (actualNode.toString().contains("@parameter"))
				lineUseMap.put(n.getOffset().toString(), new ExternalPara(
						sootUse.get(0).getValue().toString()));
			// case : new StringBuilder
			// !!
			else if (actualNode.toString().contains(
					"= new java.lang.StringBuilder")
					|| actualNode.toString().contains(
							"= new java.lang.StringBuffer"))
				lineUseMap
						.put(n.getOffset().toString(), new ConstantString(""));
			...
			// string manipulation
				...
				for (ValueBox vb : sootUse) {
					...
					if (!use.contains("virtualinvoke")
						...
						} else if ((use.contains("b") || use.contains("i"))
								|| use.contains("c") || use.contains("z")
								|| use.contains("d") || use.contains("l")
								&& !use.contains("\"")) {
						...
						if (use.contains("<java.lang.String: java.lang.String replace(char,char)>"))
							op = new Operation("replace(char,char)");
								...
								.contains("<java.lang.String: java.lang.String replace(java.lang.CharSequence,java.lang.CharSequence)>"))
							op = new Operation(
									"replace(java.lang.CharSequence,java.lang.CharSequence)");
						else if (use
								.contains("<java.lang.String: java.lang.String replaceAll(java.lang.String,java.lang.String)>"))
							op = new Operation("replaceAll");
						else if (use
								.contains("<java.lang.String: java.lang.String replaceFirst(java.lang.String,java.lang.String)>"))
							op = new Operation("replaceFirst");
						else if (use
								.contains("<java.lang.String: java.lang.String toUpperCase()>"))
							op = new Operation("toUpperCase");
						else if (use
								.contains("<java.lang.String: java.lang.String toLowerCase()>"))
							op = new Operation("toLowerCase");
						else if (use
								.contains("<java.lang.String: java.lang.String substring(int,int)>"))
							op = new Operation("substring(int,int)");
						else if (use
								.contains("<java.lang.String: java.lang.String substring(int)>"))
							op = new Operation("substring(int)");
						else if (use
								.contains("<java.lang.String: java.lang.CharSequence subSequence(int,int)>"))
							op = new Operation("subSequence(int,int)");
						else if (use
								.contains("<java.lang.StringBuilder: java.lang.StringBuilder append")
								|| use.contains("<java.lang.StringBuffer: java.lang.StringBuffer append")) {

							op = new Operation("append");
						} else if (use
								.contains("<java.lang.String: java.lang.String trim()>"))
							op = new Operation("trim");
						else if (use
								.contains("<java.lang.String: java.lang.String intern()>"))
							op = new Operation("intern()");
						else if (use
								.contains("<java.lang.String: java.lang.String[] split(java.lang.String)>"))
							op = new Operation("split(java.lang.String)");
						else if (use
								.contains("<java.lang.String: java.lang.String[] split(java.lang.String,int)>"))
							...
							op = new Operation("contains");
								...
								.contains("<java.lang.String: char charAt(int)>"))
							op = new Operation("charAt");
						else if (use
								.contains("<java.lang.String: char[] toCharArray()>"))
							op = new Operation("toCharArray");

						// non java.lang method
						else if (use
								.contains("<java.net.URLEncoder: java.lang.String encode(java.lang.String,java.lang.String)>")) {
							...
							ignore = true;
							lineUseMap.put(n.getOffset().toString(),
									new ExternalPara("Unknown"));
							// System.out.println("virtual invoke case missing: "+
							// use);
						}
				...
				if (!ignore) {
					...
					lineUseMap.put(n.getOffset().toString(), new Expression(
							operandList, op));
				...
				lineUseMap.put(n.getOffset().toString(), new ConstantString(
						"null"));
				// Haven't handled ,if a array element is never assign, it will
				// fail

				// lineUseMap.put(n.getOffset().toString(), new
				// ConstantString("newarray"));
			}
...
//					 System.out.println("GOT"+signature);
					...
					lineUseMap.put(n.getOffset().toString(), new ExternalPara(
							signature+"!"+methodName+"!"+n.getOffset().toString()));
				...
				if (sootUse.size() == 1) {
					...
					// case: r = null
						...
						if (v instanceof FieldRef) {
							lineUseMap.put(n.getOffset().toString(),
									new ExternalPara(((FieldRef) v).getField()
											.getSignature()));
							// System.out.println("Field:"+
							// ((FieldRef)v).getField().getTags());
						} else if (v.toString().equals("null"))
							lineUseMap.put(n.getOffset().toString(),
									new ConstantString("null"));
					...
					// case: r = r.something
					if (actualNode.toString().matches(
							"(.r|r)([0-9]*)(.*) = (.r|r)([0-9]*)(.*)")) {
					...
					} else if (actualNode.toString().matches(
							"(.r|r)([0-9]*)(.*) = \"(.*)\"")) {
						for (ValueBox vb : sootUse) {
							if (!(vb instanceof JimpleLocalBox || vb instanceof ImmediateBox)) {
								String use = vb.getValue().toString();
				...
				if (use.contains("(char) b") || use.contains("(char) i")) {
					...
					operandList.add(op1);
					lineUseMap.put(n.getOffset().toString(), new Expression(
							operandList, new Operation("CastChar")));
				} else {
									...
									if (use1.contains("[")/*
										...
										if (regionDef.get(tmp) == null)
											...
											if (regionDef.get(tmp))
												lineUseMap.put(n.getOffset()
														.toString(),
														new InternalVar(use1));
											else
												lineUseMap.put(n.getOffset()
														.toString(),
														new ExternalPara(use1));
										}
									}
								} else {
			...
			} else if (actualNode.toString().matches("b(.*) = (.*)")
					&& sootUse.size() == 1) {
				String use = sootUse.get(0).getValue().toString();
				if (use.matches("b[0-9]+")) {
					...
					lineUseMap.put(n.getOffset().toString(), new ConstantInt(
							use));
				}
			}

			// r = *invoke
			else if (actualNode.toString().contains("staticinvoke")
					|| actualNode.toString().contains("specialinvoke")
					|| actualNode.toString().contains("virtualinvoke")
					|| actualNode.toString().contains("interfaceinvoke")) {

				String methodName = ((Stmt) actualNode).getInvokeExpr()
					...
					for (int i = 0; i < listOfFiles.length; i++) {
						if (listOfFiles[i].getName().equals(file)) {
							...
							try {
								...
								// Create new ObjectInputStream object to read
								// object from file
								...
								while (fis.available() != -1) {
									...
									try {
										fromOtherMethod.add((Variable) obj
												.readObject());
				...
				// replace the externalPara with internal or the extenalPara in
				// the current method
				...
				if (!temp.isEmpty())
					lineUseMapFromOtherMethod.put(n.getOffset().toString(),
							temp);
				else {
					// if the method return an String but we don't have the
					// summary for that method, return method name.
					if (actualNode.getUseBoxes().get(0).getValue().getType()
							.toString().equals("java.lang.String")) {

						// if getString(R.string.*)
						if (methodName
								.equals("<android.content.Context: java.lang.String getString(int)>")) {
							String id = null;
							for (ValueBox vb : sootUse) {
								if (vb.getValue().getType().toString()
										.equals("int")) {
									id = vb.getValue().toString();
								}
							}
							// if getString(R.string.*)
							ExternalPara ep = new ExternalPara(id);
							ep.setType("strings.xml");
							lineUseMap.put(n.getOffset().toString(), ep);
						} else {
							lineUseMap.put(n.getOffset().toString(),
									new ExternalPara("!!!"
											// +actualNode.getUseBoxes().get(1).getValue().toString()
											+ methodName
											+ n.getOffset().toString()
											+ ":"
											+ actualNode.getDefBoxes().get(0)
													.getValue().toString()
											+ "!!!"));
						}
			...
			// b0 = 1,$i1 = b0 + 1
				...
				&& !actualNode.getUseBoxes().isEmpty()) {

			if (actualNode.getUseBoxes().get(0).getValue().getType().toString()
					.equals("java.lang.String")) {
				String returnNodeName = actualNode.getUseBoxes().get(0)
						.getValue().toString();
				if (returnNodeName.contains("\""))
					returnVarNodeAndName.put(n, new ConstantString(
							returnNodeName));
				else {
					if (regionDef.get(returnNodeName) == null)
						returnVarNodeAndName
								.put(n, new ExternalPara("Unknown"));
					else {
						if (regionDef.get(returnNodeName))
							returnVarNodeAndName.put(n, new InternalVar(
									returnNodeName));

						else { // IT SHOULD BE DEAD CODE
							returnVarNodeAndName.put(n, new ExternalPara(
									returnNodeName));
						}
					}
				}
				...
				&& actualNode
						.toString()
						.contains(
								"<LoggerLib.Logger: void reportString(java.lang.String,java.lang.String)>")
				&& !actualNode.toString().contains("goto")) {
			if (!targetVarNodeAndName.keySet().contains(n)) {
				...
				if (actualNode.getUseBoxes().size() != 3)
					...
					nameAndLabel.add(actualNode.getUseBoxes().get(0).getValue()
							.toString());
					nameAndLabel.add(actualNode.getUseBoxes().get(1).getValue()
							.toString());
				}
				targetVarNodeAndName.put(n, nameAndLabel);
		...
		// *invoke
				...
				&& (actualNode.toString().contains("staticinvoke")
						|| actualNode.toString().contains("virtualinvoke")
						|| actualNode.toString().contains("specialinvoke") || actualNode
						.toString().contains("specialinvoke"))
				&& !actualNode.toString().contains("<init>")
				&& !actualNode.toString().contains("goto")) {

			String signature = ((Stmt) actualNode).getInvokeExpr().getMethod()
					.getSignature();
	...
	private Variable replaceExternal(Variable v, List<ValueBox> valueBox) {
		if (v instanceof ExternalPara) {
			if (((ExternalPara) v).getName().contains("@parameter")) {
				String tmp = ((ExternalPara) v).getName().split(":")[0]
